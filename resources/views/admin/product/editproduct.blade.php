                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{route('edit.product.post',['id'=>$detail->productid])}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="productname" name="productname" disabled class="form-control" value="{{$detail->productname}}">
                                                @error('productname')
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2  col-form-label" for="example-placeholder">Product description</label>
                                            <div class="col-sm-10">
