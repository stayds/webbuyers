                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                <p>Dear {{$verifyuser->name}},</p>
                                                                                <p>Please follow this link: <br><a href="{{url($verifyurl)}}">{{$verifyurl}}</a> to verify your mail and complete registration.</p>
                                                                                <br>
                                                                                <p>Cheers,<br />
                                                                                    <b>Bulk Buyers Connect Team</b> </p>
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; 2019 <a href="http://www.bulkbuyersconnect.com/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Bulk Buyers Connect</span></a>. All&nbsp;rights&nbsp;reserved.</div>
