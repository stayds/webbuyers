...
<head>
    ...
    <title>Bulk Buyers Connect - Email Notification</title>
    <style type="text/css">
        /* RESET STYLES */
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                ...
                                                                <h1 style="color:#fff;line-height:120%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:5px;text-align:center;">Account Creation</h1>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                <p>Dear {{$user->fname}},</p>
                                                                                <p>Welcome to the Bulk Buyers Connect family… </p>
                                                                                <p>An account has been created with the following;<br>
                                                                                    <span>Email</span>: <span>{{$user->email}}</span><br>
                                                                                    Please contact the Administrator for other login credentials
                                                                                </p>
                                                                                <br>
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; Date('Y') <a href="http://www.bulkbuyersconnect.com/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Bulk Buyers Connect</span></a>. All&nbsp;rights&nbsp;reserved.</div>
                                                                    <div>You are receiving this email because you just registered on our portal. Please ignore if you receive this by error.</div>
                                                                </div>
