                ...
                <table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#000;" bgcolor=" @if($paymentdetail->paymentstatusid === 2) limegreen @else red @endif">
                                <tr>
                                    <td align="center" valign="top">
                                        <!-- FLEXIBLE CONTAINER // -->
                                        <!--
                                                        ...
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    ...
                                                                    <div>You are receiving this email because you are transacting on our portal. Please ignore if you receive this by error.</div>
                                                                </div>
